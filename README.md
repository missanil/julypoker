...
July Poker can be installed on a phone as a Progressive Web App, giving players a dedicated home-screen icon and a more app-like full-screen experience.

To install it:
- Open `https://missanil.github.io/julypoker/` in Safari on iPhone/iPad or Chrome on Android.
- Open the browser share/menu controls.
- Choose **Add to Home Screen**, **Install app**, or **Add to Home screen**, depending on the browser.
- Confirm the app name and installation prompt.

After installation, launch July Poker from the home screen. Saved games remain tied to the device and browser storage used by the installed app.
